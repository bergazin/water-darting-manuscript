...
class WaterTranslationRotationMove(Move):
    ...
    def __init__(self, structure, water_name='WAT', radius=1.5*unit.nanometers):
        ...
        self.traj = mdtraj.load('H_5j64.pdb')
    ...
    def beforeMove(self, nc_context):
        ...
        while not is_inside_sphere:
            ...
            water_index = np.random.randint(2,len(self.water_residues))
