...
class WaterTranslationRotationMove(Move):
    ...
    def __init__(self, structure, water_name='WAT', radius=5.0*unit.nanometers):
        ...
        self.traj = mdtraj.load('04_Prod_MC_004.restrt.pdb')
    ...
    def beforeMove(self, nc_context):
        ...
        while not is_inside_sphere:
            ...
            print("water_index type", type(water_index))
            ...
            #water_choice = np.int(water_choice)
            #print("water_choice", water_choice)
            #print("water_choice type", type(water_choice))

            #print("Before - water_index", water_index)
            #print("Before - self.water_residues[water_index]", self.water_residues[water_index])
            ...
            #    water_choice = self.water_residues[water_index]
            #    print("water_choice idx", water_choice)
            #    print("random water start pos", start_pos[water_choice])
            #print("After - water_index", water_choice)
            #print("random water start pos", start_pos[water_choice])
            #import numpy as np
    ...
    def move(self, context):
        ...
        #print("water distance*movePos.unit",water_distance*movePos.unit)
        ...
        #    movePos[resnum] = movePos[resnum] + sphere_displacement
